                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='mb-6'>
                            ...
                            <div className={loginStyles.inputContainer}>
                                ...
                                <input type='email' id='email' value={email} onChange={(e)=>setEmail(e.target.value)} className={loginStyles.input} placeholder='youremail@gmail.com' required/>
                            </div>
                        </div>
                        <div className='mb-6'>
                        ...
                        <div className={loginStyles.checkboxContainer}>
                            <input type="checkbox" id='remember' checked={rememberMe} onChange={(e)=>setRememberMe(e.target.checked)} className={loginStyles.checkboxInput}/>
