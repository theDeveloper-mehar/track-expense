...
import { Activity, ArrowDown, ArrowUp, Car, ChevronDown, Clock, CreditCard, DollarSign, Gift, Home, Info, PieChart, PiggyBank, RefreshCw, ShoppingCart, TrendingUp, Utensils, Zap } from 'lucide-react';
        ...
        <div className={styles.grid.main}>
          ...
          <div className={styles.grid.rightColumn}>
            <div className={styles.cards.base}>
              ...
              <div className='flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-md mb-4'>
