...
import { ArrowDown, ArrowUp, Home, LogOut, User, HelpCircle, X, Menu } from 'lucide-react';
const MENU_ITEMS = [
...
const handleLogout =()=>
{
  ...
  return (
    <>
    <motion.div ref={sidebarRef} className={sidebarStyles.sidebarContainer.base} initial={{x:-100 , opacity :0}} animate={{
        x:0,
        opacity:1,
    ...
    <div className={sidebarStyles.sidebarInner.base}>
        ...
        <div className={cn(
            sidebarStyles.userProfileContainer.collapsed.base,
