...
const Signup = ({ API_URL = import.meta.env.VITE_API_URL, onSignup }) => {
...
const data = res.data || {};
            ...
            <form onSubmit={handleSubmit} noValidate>
                <div className="mb-6">
                    ...
                    <div className={signupStyles.inputContainer}>
                        ...
                        <input type='text' id='name' value={name} onChange={(e)=>setName(e.target.value)} className={`${signupStyles.input} ${
                            errors.name ?"border-red-300" : "border-gray-200"
                        }`} placeholder='John Doe'/>
                    </div>
                    {
                        errors.name && (<p className={signupStyles.fieldError}>
                            {errors.name}
                        </p>)
                    }
                </div>
                 ...
                 <div className="mb-6">
                    ...
                    <div className={signupStyles.inputContainer}>
                        ...
                        <input type='email' id='email' value={email} onChange={(e)=>setEmail(e.target.value)} className={`${signupStyles.input} ${
                            errors.email ?"border-red-300" : "border-gray-200"
                        }`} placeholder='Your@email.com'/>
                    </div>
                    {
                        errors.email && (<p className={signupStyles.fieldError}>
                            {errors.email}
                        </p>)
                    }
                </div>
 <div className="mb-6">
                    ...
                    <div className={signupStyles.inputContainer}>
                        ...
                        <input type={showPassword ? "text" : "password"} id='password' value={password} onChange={(e)=>setPassword(e.target.value)} className={`${signupStyles.passwordInput} ${
                    ...
                    {
                        errors.password && (<p className={signupStyles.fieldError}>
                            {errors.password}
                        </p>)
                    }
                </div>
