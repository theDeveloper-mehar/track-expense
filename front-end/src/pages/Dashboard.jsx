...
import { Plus, TrendingDown, TrendingUp, Wallet ,ArrowDown, PiggyBank, BarChart2, ChevronDown, ChevronUp, ShoppingCart, DollarSign , TrendingUp as ProfitIcon , PieChart as PieChartIcon  } from 'lucide-react';
...
const totalIncome = currentTimeFrameData.income;
setGaugeData([
  { name: "Income", value: totalIncome, max: totalIncome },
  { name: "Spent", value: currentTimeFrameData.expenses, max: totalIncome },
  { name: "Savings", value: currentTimeFrameData.savings, max: totalIncome },
]);
        }
      } else {
  ...
  return (
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.summaryGrid}>
          <FinancialCard icon={<div className={dashboardStyles.walletIconContainer}>
            ...
            additionalContent={
             ...
             <FinancialCard icon={<div className={dashboardStyles.arrowDownIconContainer}>
          ...
          <FinancialCard icon={<div className={dashboardStyles.piggyBankIconContainer}>
